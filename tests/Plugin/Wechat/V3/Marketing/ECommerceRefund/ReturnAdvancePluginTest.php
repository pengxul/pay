...
use Pengxul\Pay\Plugin\Wechat\V3\Marketing\ECommerceRefund\ReturnAdvancePlugin;
...
class ReturnAdvancePluginTest extends TestCase
{
    ...
    public function testModeWrong()
    {
        ...
        self::expectExceptionMessage('参数异常: 平台收付通（退款）-垫付退款回补，只支持服务商模式，当前配置为普通商户模式');
    ...
    public function testEmptyPayload()
    {
        ...
        self::expectExceptionMessage('参数异常: 平台收付通（退款）-垫付退款回补，缺少必要参数 `refund_id`');
